 ...
 * 当前版本先保留位定义，具体检测输入后续硬件联调时补充。
 */
#define BASE_ERR1_MED_PUMP1_LOW      0x01U  /* 药液泵 1 液位低。 */
#define BASE_ERR1_MED_PUMP2_LOW      0x02U  /* 药液泵 2 液位低。 */
#define BASE_ERR1_CLEAN_LOW          0x04U  /* 清洁液液位低。 */
#define BASE_ERR1_LEVEL_BOARD        0x08U  /* 液位板通信或检测异常。 */
#define BASE_ERR1_MED_PUMP1          0x10U  /* 药液泵 1 故障。 */
#define BASE_ERR1_MED_PUMP2          0x20U  /* 药液泵 2 故障。 */
...
/* 基站协议工作状态，通过状态上报帧 data[23] 发送给桶体。 */
typedef enum
{
...
/* 返回状态帧 data[24]：按当前状态表示已运行秒数或剩余分钟数。 */
